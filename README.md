...
Stable-версия `0.1.1` использует новую внутреннюю схему Garmin storage без миграции
из `0.1.0`. При обновлении с `0.1.0` нужно удалить прежнее Garmin-приложение с часов,
установить PRG заново и повторно синхронизировать секреты с Android.
...
Параметры и SHA-256 квалифицированной stable-версии `0.1.1` находятся в
