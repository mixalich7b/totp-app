...
Это описание последней аппаратно квалифицированной версии. Текущие исходники имеют
версию `0.1.1`; её hashes не фиксируются здесь до ручной проверки после чистой
переустановки Garmin-приложения.
