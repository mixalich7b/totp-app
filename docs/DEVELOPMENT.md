...
Усиление автоматических тестов завершено. Следующий активный этап — пользовательские
сценарии синхронизации; актуальный остаток работ перечислен в
[IMPLEMENTATION_PLAN.md](../IMPLEMENTATION_PLAN.md#83-доработка-пользовательских-сценариев).
...
Android unit-набор содержит 48 тестов. Детерминированные property/fuzz-сценарии
